  ...
  function decolorElement(element) {
    if (element.children[0]) {
      if (element.children[0].nodeName === "svg") {
        ...
        element.children[0].children[0].children[0].style.backgroundColor =
          "#333";
        element.children[0].children[1].children[0].style.backgroundColor =
          "#333";
      }
    }
  }
